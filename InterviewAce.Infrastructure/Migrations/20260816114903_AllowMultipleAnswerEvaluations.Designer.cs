...
namespace InterviewAce.Infrastructure.Migrations
{
    ...
    [Migration("20260816114903_AllowMultipleAnswerEvaluations")]
    partial class AllowMultipleAnswerEvaluations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InterviewAce.Domain.Entities.Interview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InterviewAce.Domain.Entities.InterviewAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InterviewAce.Domain.Entities.InterviewQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ExpectedTopics")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("InterviewAce.Domain.Entities.InterviewSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InterviewAce.Domain.Entities.JobMatchAnalysis", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InterviewAce.Domain.Entities.Interview", b =>
                {
                    b.HasOne("InterviewAce.Domain.Entities.JobDescription", "JobDescription")
                        .WithMany()
                        .HasForeignKey("JobDescriptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InterviewAce.Domain.Entities.ResumeAnalysis", "ResumeAnalysis")
                        .WithMany()
            ...
            modelBuilder.Entity("InterviewAce.Domain.Entities.InterviewAnswer", b =>
                {
                    b.HasOne("InterviewAce.Domain.Entities.InterviewQuestion", "InterviewQuestion")
                        .WithMany()
                        .HasForeignKey("InterviewQuestionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InterviewAce.Domain.Entities.InterviewSession", "InterviewSession")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("InterviewAce.Domain.Entities.InterviewQuestion", b =>
                {
                    b.HasOne("InterviewAce.Domain.Entities.Interview", "Interview")
                        .WithMany("Questions")
